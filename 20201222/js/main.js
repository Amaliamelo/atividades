...
$(document).ready(function(){
    ...
    $("#cad_emprestimo").click(function(){
            var genero = $("select[name='genero_modal']").val();
            var livro = $("input[name='id_livro']").val();
            var usuario = $("input[name='usuario']").val();
            var data = $("input[name='data_modal']").val();
            var data_devolucao = $("input[name='data_devolucao']").val();
            var id=3;
            var aux=0;
            ...
            $.get("insere.php", {"id":id, "genero":genero,"livro":livro, "usuario":usuario, "data":data, "data_devolucao":data_devolucao}, function(msg){
                console.log(msg);
                $("#msg").html(msg);
