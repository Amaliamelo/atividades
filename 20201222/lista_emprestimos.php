<?php
    ...
    if($_SESSION["permissao"]=="2"){
        ...
        while($linha = mysqli_fetch_assoc($resultado)){
            echo '<tr>
                    ...
                    <td>'.date("d/m/y", strtotime($linha["data_devolucao"])).'</td>
                </tr>';
                $i++; 
        }
        if($i==0){
    ...
    elseif($_SESSION["permissao"]=="1"){
        ...
        $select = "SELECT  nome_genero, titulo, nome_usuario, data_emprestimo, id_emprestimo, data_devolucao FROM emprestimo INNER JOIN genero 
