...
<?php 
    ...
    switch($_GET["id"]){
        ...
        case 1:
            ...
            $select = "SELECT livro.autor, genero.nome_genero, titulo, ano, paginas, editora, id_livro  FROM livro INNER JOIN genero ON livro.cod_genero = genero.id_genero";
        ...
        case 2:
            ...
            echo '<tr>
                    ...
                    <td>
                        <button class="btn btn-dark remover_livro" value="'.$linha["cpf"].'">Remover</button>
                    </td>
                </tr>'; 
            }
